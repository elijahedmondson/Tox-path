...
BW <- ggplot(data) + 
  ...
  geom_jitter(aes(x = Group, y = Weight, color = `Day`), width = 0.1, size = 2)+
...
### Brain plot
Brain <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$"Brain Weight", color = `Day`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Heart plot
Heart <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Heart Weight', color = `Day`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Liver plot
Liver <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Liver Weight', color = `Day`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Lung plot
Lung <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Lung Weight', color = `Day`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
Spleen <- ggplot(data) + 
  ...
  #geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4 , size=0.5) +
  geom_jitter(aes(x = Group, y = data$'Spleen Weight', color = `Day`), width = 0.1, size = 2) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
  theme(axis.title.x=element_blank(), text = element_text(size = 12))
...
### Kidney plot
Kidney <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Kidney Weight', color = `Day`), width = 0.1, size = 2) +
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Graft plot
Graft <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Graft Weight', color = `Day`), width = 0.1, size = 2) +
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Brain plot
Brain <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$"Brain % BW", color = `Day`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Heart plot
Heart <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Heart % BW', color = `Day`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Liver plot
Liver <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Liver % BW', color = `Day`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Lung plot
Lung <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Lung % BW', color = `Day`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Spleen plot
Spleen <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Spleen % BW', color = `Day`), width = 0.1, size = 2) +
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Kidney plot
Kidney <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Kidney % BW', color = `Day`), width = 0.1, size = 2) +
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
...
### Graft plot
Graft <- ggplot(data) + 
  geom_jitter(aes(x = Group, y = data$'Graft % BW', color = `Day`), width = 0.1, size = 2) +
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
