...
tiff("CBC_WBC.tiff", units="in", width=10, height=8, res=200)
(plot_list[[31]] | plot_list[[32]]) / 
  (plot_list[[33]]  | plot_list[[34]]) /
  (plot_list[[35]]  | plot_list[[36]]) /
  (plot_list[[45]]  | plot_list[[46]]) /
  plot_layout(guides = "collect") + 
  plot_annotation(title = "CBC: White Blood Cell and Platelet Counts")
dev.off()

tiff("CBC_RBC.tiff", units="in", width=10, height=8, res=200)
(plot_list[[37]] | plot_list[[38]]) / 
  (plot_list[[39]]  | plot_list[[40]]) /
  (plot_list[[41]]  | plot_list[[42]]) /
  (plot_list[[43]]  | plot_list[[44]]) /
  plot_layout(guides = "collect") + 
...
tiff("Absolute organ weights.tiff", units="in", width=10, height=8, res=200)
(plot_list[[15]]) / 
  (plot_list[[16]]  | plot_list[[18]]) /
...
tiff("Relative organ weights.tiff", units="in", width=10, height=8, res=200)
(plot_list[[15]]) / 
