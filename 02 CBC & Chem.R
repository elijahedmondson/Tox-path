...
### Nuetrophils plot
ymxNE = max(c(data$NE, my_info$ref.hi),na.rm=T)
yminNE = min(c(data$NE, my_info$ref.low),na.rm=T)
NE <- ggplot(data) + 
...
### Lymphocyes plot
ymxLY = max(c(data$LY, my_info$ref.hi),na.rm=T)
yminLY = min(c(data$LY, my_info$ref.low),na.rm=T)
LY <- ggplot(data) + 
...
### Monocytes plot
ymxMO = max(c(data$MO, my_info$ref.hi),na.rm=T)
yminMO = min(c(data$MO, my_info$ref.low),na.rm=T)
MO <- ggplot(data) + 
...
### Eosinophils plot
ymxEO = max(c(data$EO, my_info$ref.hi),na.rm=T)
yminEO = min(c(data$EO, my_info$ref.low),na.rm=T)
EO <- ggplot(data) + 
...
### Basophils plot
ymxBA = max(c(data$BA, my_info$ref.hi),na.rm=T)
yminBA = min(c(data$BA, my_info$ref.low),na.rm=T)
BA <- ggplot(data) + 
...
### Hematocrit plot
ymxHCT = max(c(data$HCT, my_info$ref.hi),na.rm=T)
yminHCT = min(c(data$HCT, my_info$ref.low),na.rm=T)
HCT <- ggplot(data) + 
...
### Reticulocytes plot
ymxRET = max(c(data$Retics, my_info$ref.hi),na.rm=T)
yminRET = min(c(data$Retics, my_info$ref.low),na.rm=T)
Retics <- ggplot(data) + 
...
### MCH plot
ymxMCH = max(c(data$MCH, my_info$ref.hi),na.rm=T)
yminMCH = min(c(data$MCH, my_info$ref.low),na.rm=T)
MCH <- ggplot(data) + 
...
### MCV plot
ymxMCV = max(c(data$MCV, my_info$ref.hi),na.rm=T)
yminMCV = min(c(data$MCV, my_info$ref.low),na.rm=T)
MCV <- ggplot(data) + 
...
### MCHC plot
ymxMCHC = max(c(data$MCHC, my_info$ref.hi),na.rm=T)
yminMCHC = min(c(data$MCHC, my_info$ref.low),na.rm=T)
MCHC <- ggplot(data) + 
...
### Hb plot
ymxHb = max(c(data$Hb, my_info$ref.hi),na.rm=T)
yminHb = min(c(data$Hb, my_info$ref.low),na.rm=T)
Hb <- ggplot(data) + 
...
### ymxRBC plot
ymxRBC = max(c(data$RBC, my_info$ref.hi),na.rm=T)
yminRBC = min(c(data$RBC, my_info$ref.low),na.rm=T)
RBC <- ggplot(data) + 
...
### RDW plot
ymxRDW = max(c(data$RDW, my_info$ref.hi),na.rm=T)
yminRDW = min(c(data$RDW, my_info$ref.low),na.rm=T)
RDW <- ggplot(data) + 
...
### Platelets plot
ymxPLT = max(c(data$PLT, my_info$ref.hi),na.rm=T)
yminPLT = min(c(data$PLT, my_info$ref.low),na.rm=T)
PLT <- ggplot(data) + 
...
### Platelets plot
ymxMPV = max(c(data$MPV, my_info$ref.hi),na.rm=T)
yminMPV = min(c(data$MPV, my_info$ref.low),na.rm=T)
MPV <- ggplot(data) + 
