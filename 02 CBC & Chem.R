...
AGR <- ggplot(data) + 
  ...
  #geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = AGR, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
BCR <- ggplot(data) + 
  ...
  #geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = BCR, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
ALB <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = ALB, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
ALP <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = ALP, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
ALT <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = ALT, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
BUN <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = BUN, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
GLU <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = GLU, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
TP <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = TP, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
GLOB <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = GLOB, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
Ca <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = Ca, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
PHOS <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = PHOS, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
NaPlus <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = NaPlus, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
...
KPlus <- ggplot(data) + 
  ...
  geom_errorbar(data = my_info, aes(x = Group, ymin = ref.low, ymax = ref.hi), color = "#f5f5f5", width = 0, size=10) +
  geom_jitter(aes(x = Group, y = KPlus, color = `Groups`), width = 0.1, size = 2)+
  geom_point(data = my_info, aes(x = Group , y = mean), color = "#a9a9a9", size = 3) +
  geom_errorbar(data = my_info, aes(x = Group, y = CIdiff, ymin = mean - CIdiff, ymax = mean + CIdiff), color = "#a9a9a9", width = 0.4, size=0.7) +
  theme_bw() +
  theme(axis.text.x=element_text(angle=25,hjust=1)) +
