...
tiff("01. WBC+PLT.tiff", units="in", width=10, height=13, res=300)
(WBC | NE) /
  (LY | MO) / 
  (EO | BA )/
  (PLT | MPV) /
...
tiff("02. RBC.tiff", units="in", width=10, height=13, res=300)
(HCT | RBC) /
  (Hb | MCH) / 
  (MCHC | MCV) /
  (Retics | RDW) /
...
tiff("03. Chem.tiff", units="in", width=15, height=16, res=300)
